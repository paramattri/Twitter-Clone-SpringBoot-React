...
class TweetServiceTest {
	...
	void testRetrieveAllTweets() {
		...
		Tweet tweet = new Tweet(1,"Param Attri", "Pattri", true, "#Diwali", LocalDateTime.now(), "tweet image", "tweet Avatar");
		Tweet tweet2 = new Tweet(1,"Prateek", "Pjoshi", false, "#Holi", LocalDateTime.now(), "tweet image", "tweet Avatar");
	...
	void testRetrieveTweetsByUserName() {
		Tweet tweet = new Tweet(1,"Param Attri", "Pattri", true, "#Diwali", LocalDateTime.now(), "tweet image", "tweet Avatar");
		Tweet tweet2 = new Tweet(2,"Param Attri", "Pattri", true, "#Holi", LocalDateTime.now(), "tweet image", "tweet Avatar");
		List<Tweet> tweets = new ArrayList<Tweet>();
		tweets.add(tweet);
		tweets.add(tweet2);
	...
	void testRetrieveTweetsByTweetId() {
		int tweetId = 10;
		Tweet tweet = new Tweet(10,"Param Attri", "Pattri", true, "#Diwali", LocalDateTime.now(), "tweet image", "tweet Avatar");
